...
│   │   ├── Header.vue # загаловок, включающий в себя лого и иконку профиля
│   │   ├── Map.vue # Основной компонент карты. 
│   │   ├── MapControls.vue # Дополнительные кнопки управления картой 
│   │   ├── SearchBar.vue # Выдвигающаяся нижняя панель, которая включает в себя: Поиск, Закладки
