...
class PromoReward(models.Model):
    reward = models.ForeignKey(
        Reward, on_delete=models.CASCADE, related_name="promo_rewards")
...
class LoyaltyReward(models.Model):
    reward = models.ForeignKey(
        Reward, on_delete=models.CASCADE, related_name="loyalty_rewards")
...
class UserLoyaltyBalance(models.Model):
    user = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="loyalty_balance")
